...
{
    public class UpdateHouseHandler : IRequestHandler<UpdateHouse, House>
    {
        private readonly IUnitOfWork _unitOfWork;

        public UpdateHouseHandler(IUnitOfWork unitOfWork)
        {
            _unitOfWork = unitOfWork;
        }

        public async Task<House> Handle(UpdateHouse request, CancellationToken cancellationToken)
        {
            var toUpdate = new House
            {
                Id = request.Id,
                Type = request.Type,
                Title = request.Title,
            ...
            _unitOfWork.HouseRepository.Update(toUpdate);
