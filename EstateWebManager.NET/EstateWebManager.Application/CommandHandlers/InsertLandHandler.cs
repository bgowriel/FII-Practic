...
{
    public class InsertLandHandler : IRequestHandler<InsertLand, Land>
    {
        private readonly IUnitOfWork _unitOfWork;

        public InsertLandHandler(IUnitOfWork unitOfWork)
        {
            _unitOfWork = unitOfWork;
        }

        public async Task<Land> Handle(InsertLand request, CancellationToken cancellationToken)
        {
            var land = new Land
            {
                Type = request.Type,
            ...
            await _unitOfWork.LandRepository.Insert(land);
